...
export function PostCard({ post }: PostCardProps) {
  return (
    <Card className="group bg-card/50 border-border/40 hover:border-primary/20 gap-0 overflow-hidden border p-0 backdrop-blur-sm transition-all duration-300 hover:scale-[1.02] hover:shadow-lg">
      {post.coverImage && (
